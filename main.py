...
def make_predictions(input_df, input_dict):
  ...
  with col1:
    ...
    st.write(f"The customer has a {avg_probability: 0.2%} probability of churning.")
...
- Your explanation should be based on the customer's information, the summary statistics of churned and non-churned customers, and the feature importances provided. Do not blindly display the customer's information.
